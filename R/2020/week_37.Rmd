...
g = ggraph(friends_graph, layout = 'linear') +
  ...
  labs(caption = "Data: {friends} R package and ceros.com. Created by: @loreabad6") +
  theme(
    text = element_text(family = 'Friends', color = 'white', size = 8),
...
## Save plot
```{r}
ggsave(g, filename = "plot/2020_week_37.png", device = "png", width = 30, height = 10, units = "cm")
```
