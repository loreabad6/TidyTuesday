...
Now we can prepare the title, subtitle, caption and a short description to be included in the plot. Colors in the description correspond to the points used in the final map. This assignment was done manually. The text is wrapped around `<span>` tags to pass them to `ggtext` functions later.

```{r, include = F}
# Repeated below just to show nicer on markdown, 
# the description should have no line breaks!
